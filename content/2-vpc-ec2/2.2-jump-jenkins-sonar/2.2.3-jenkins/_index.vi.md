...
Jenkins Server sẽ là nơi thực hiện hầu hết các Pipeline của chúng ta: CI Pipeline và Pipeline cho DevSecOps. Mỗi lần có một commit mới ở Dev Repo hoặc Ops Repo, Jenkins sẽ tự động chạy các pipeline dựa vào cách mà ta cấu hình.
