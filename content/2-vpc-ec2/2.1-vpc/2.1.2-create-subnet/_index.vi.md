...
Tạo file `Terraform/02-subnet.tf` để tạo subnet như bên dưới:
...
```
#### Route Table và Subnet Association

Kế tiếp, ta sẽ tạo các Route Table, đồng thời associate Internet Gateway, NAT Gateway, và các Subnets. Tạo File `Terraform/03-route_table.tf` như bên dưới:
